...
- [Layer 2: Restricting Access to Cloudflare Only](#layer-2-restricting-access-to-cloudflare-only)
- [Implementing Origin Protection in Practice](#implementing-origin-protection-in-practice)
  - [Step 1: Find Cloudflare’s IP Ranges](#step-1-find-cloudflares-ip-ranges)
  - [Step 2: Configure Your Firewall](#step-2-configure-your-firewall)
  - [Step 3: Verify Origin Protection](#step-3-verify-origin-protection)
- [Automating Firewall Rules Updates](#automating-firewall-rules-updates)
- [Handling Legitimate Access (SSH, SFTP, etc)](#handling-legitimate-access-ssh-sftp-etc)
